...
parser.add_argument("--image_dir", default='/home/deep/1-POJECT/e2ec/e2ec-mutil/test',help='/home/deep/1-POJECT/e2ec/e2ec-mutil/test')
...
parser.add_argument("--output_dir", default='', help='/path/to/output_dir')
