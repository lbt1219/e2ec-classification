...
class commen(object):
    ...
    points_per_poly = 128
    down_ratio = 4
    result_dir = '/home/deep/DATA/train_log/e2ec/real/bigdivide/3320'
    record_dir = '/home/deep/DATA/train_log/e2ec/real/bigdivide/3320'
    model_dir = '/home/deep/DATA/train_log/e2ec/real/bigdivide/3320'
...
class train(object):
    ...
    optimizer = {'name': 'adam', 'lr': 1e-4,
                 'weight_decay': 5e-4,
                 'milestones': [15,50,150 ],  #设置在第几轮下降学习率  0.00005 0.000025 0.000013
                 'gamma': 0.5}   #下降为原来的0.5
    batch_size = 24
    num_workers = 8
    epoch = 140
