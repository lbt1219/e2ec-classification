...
class DatasetInfo(object):
    dataset_info = {
        'coco_train': {
            'name': 'coco',
            'image_dir': '/home/deep/DATA/data/anti-vibration_hammer/coco-扩充-分开/train2017',
            'anno_dir': '/home/deep/DATA/data/anti-vibration_hammer/coco-扩充-分开/annotations/instances_train2017.json',
            'split': 'train'
        },
        'coco_val': {
            'name': 'coco',
            'image_dir': '/home/deep/DATA/data/anti-vibration_hammer/coco-扩充-分开/val2017',
            'anno_dir': '/home/deep/DATA/data/anti-vibration_hammer/coco-扩充-分开/annotations/instances_val2017.json',
            'split': 'val'
        },
        'coco_test': {
            'name': 'coco',
